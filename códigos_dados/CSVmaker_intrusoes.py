#Usado para formato yolo, para extrair classes de ficherios txt e gerar um csv com o nome do ficheiro e a label final intrusões
...
def gerar_tabela_labels(pasta_imagens, pasta_labels, nome_ficheiro_saida):
    ...
    #Verifica o que está dentro do set e atribui o label final
        ...
        people = "0" in labels_encontrados
        cat = "1" in labels_encontrados
        dog = "2" in labels_encontrados
    ...
    #Guardar na lista 
        dados_para_salvar.append([nome_imagem, labels_finais])
...
if __name__ == "__main__":
    ...
    PASTA_IMG = "Datasets_pre_mix/dataset_final_coco/test/images/val"  
    PASTA_LBL = "Datasets_pre_mix/dataset_final_coco/test/labels/val"   
    SAIDA = "dataset_teste_intrusoes_OpenImages.csv"
